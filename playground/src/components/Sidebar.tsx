...
//
//   return (
//     <CommandItem className={`ml-1 mr-1 p-0 cursor-pointer opacity-50 hover:opacity-100 ${isActive ? 'text-opacity-100 bg-muted bg-opacity-75' : ''}`}>
//       <Link href={route} className="p-2 flex grow items-center">
//         <Icon className="ml-2 mr-4 h-4 w-4" />
//         {text}
