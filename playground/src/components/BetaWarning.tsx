...
const BetaWarning = () => {
  return (
    <div className="fixed w-full pl-[260px] bottom-0 h-[56px] z-30 flex flex-row items-center justify-center bg-muted select-none sm:opacity-0 lg:opacity-100 pr-4">
