            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-1/2  mt-16">
                    <div className="flex space-x-4">
                        <AssetInput className="min-w-1/2 w-1/2" name="amount" label="Amount" balance={100} selectedAsset={amountAsset} onSelectAsset={setAmountAsset} />
                        <FormField
                    ...
                    <div className="flex space-x-4 w-full">
                        ...
                        <Button className="w-1/2" type="submit">Transfer</Button>
                    </div>
                </form>
            </Form>
        </FormProvider>);
