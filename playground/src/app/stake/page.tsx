                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
                            <div>
                                <FormItem>
                                    ...
                                    >
                                        <ToggleGroupItem value="stake" aria-label="Stake" className="grow">
                                            Stake
                                        </ToggleGroupItem>
                                        <ToggleGroupItem value="unstake" aria-label="Unstake" className="grow">
                                            Unstake
                                        </ToggleGroupItem>
                                    </ToggleGroup>
                                </FormItem>
                            ...
                            <div className="flex space-x-4">
                                <FormField
                                    ...
                                    render={({ field }) => (<FormItem className="w-1/2">
                                        ...
                                        <FormControl>
                                            <Select value={field.value} onValueChange={(value) => handleServiceChange(value as StakeSchema["service"])}>
                                                <SelectTrigger>
                                ...
                                />
                                <AssetInput className="min-w-1/2 w-1/2" name="amountIn" label="Amount" balance={100} selectedAsset={amountInAsset} onSelectAsset={setAmountInAsset} />
                            </div>
                            ...
                            <div className="flex space-x-4 w-full">
                                ...
                                <Button className="w-1/2" type="submit">{mode.charAt(0).toUpperCase() + mode.slice(1)}</Button>
                            </div>
                        </form>
                    </Form>
                </FormProvider>
