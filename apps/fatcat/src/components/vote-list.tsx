...
const ProposalItem = memo(({
  ...
  const status = useMemo(() =>
      getProposalStatus(proposal.activatedAt, proposal.votingEndsAt, proposal.canceledAt),
  ...
  return (
    <AccordionItem key={proposal.key} value={proposal.key} className="border-0 group">
