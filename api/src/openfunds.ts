...
const openfundsTemplates = [
  ...
  {
    code: "OFST010010",
    field: "Fund Domicile Alpha-2",
    tag: "essential",
    basic: true
  },
  {
    code: "OFST010020",
    field: "Legal Fund Name Including Umbrella",
    tag: "essential",
    basic: true
  },
  {
  ...
  { code: "OFST020000", field: "ISIN", tag: "essential", basic: true },
  {
    code: "OFST020540",
    field: "Share Class Currency",
    tag: "essential",
    basic: true
  },
  {
    code: "OFGL020000",
    field: "Share Class ID",
    tag: "essential",
    glam: true,
    basic: true
  }
...
export const openfunds = async (funds, template, format, client, res) => {
  ...
  try {
    ...
    res.status(404).send(err); // `Not Found: ${fund}`
  }
