...
pub struct KaminoLendingProgramInterface;

static PROGRAM_IDS: [Pubkey; 2] = [
    pubkey!("KLend2g3cP87fffoy8q1mQqGKjrxjC8boSyAYavgmjD"),
    pubkey!("SLendK7ySfcEzyaFqy93gDnD3RtrpXJcnRwb6zFHJSh"),
];

impl anchor_lang::Ids for KaminoLendingProgramInterface {
...
pub struct KaminoLendingInitUserMetadata<'info> {
    ...
    pub cpi_program: Interface<'info, KaminoLendingProgramInterface>,
