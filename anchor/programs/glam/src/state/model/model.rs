...
pub struct FundModel {
    ...
    // Openfund
    pub is_raw_openfund: Option<bool>,
    pub raw_openfund: Option<FundOpenfundModel>,
}

// Subset of the Openfund v2 modelled by Glam
#[derive(AnchorDeserialize, AnchorSerialize, Clone, Debug)]
pub struct FundOpenfundModel {
...
pub struct ShareClassModel {
    ...
    // Openfund
    pub is_raw_openfund: Option<bool>,
    pub raw_openfund: Option<ShareClassOpenfundModel>,
}

#[derive(AnchorDeserialize, AnchorSerialize, Clone, Debug)]
pub struct ShareClassOpenfundModel {
    // Essential
...
//
// Implemented:
// - Openfund Company Essential + Core + fields: email, website
